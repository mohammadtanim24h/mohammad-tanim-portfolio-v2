...
export const skillsData = {
    frontend: [
        ...
        { name: "Angular", icon: Layout, level: "Advanced" },
    ...
    backend: [
        ...
        { name: "Express", icon: TerminalSquare, level: "Expert" },
        { name: "Django", icon: TerminalSquare, level: "Advanced" },
        { name: "FastAPI", icon: Server, level: "Advanced" },
        { name: "Python", icon: TerminalSquare, level: "Advanced" },
        { name: "SQL", icon: Database, level: "Advanced" },
    ],
    database: [
        { name: "MongoDB", icon: Database, level: "Advanced" },
        { name: "Mongoose", icon: Database, level: "Advanced" },
        { name: "MySQL", icon: Database, level: "Advanced" },
    ],
    tools: [
        { name: "Docker", icon: Box, level: "Advanced" },
        { name: "Git", icon: GitBranch, level: "Expert" },
        { name: "GitHub", icon: GitBranch, level: "Expert" },
        { name: "GitLab", icon: GitBranch, level: "Advanced" },
        { name: "Postman", icon: PlugZap, level: "Advanced" },
        { name: "AWS Lambda", icon: Cloud, level: "Intermediate" },
        { name: "Azure DevOps", icon: Cloud, level: "Intermediate" },
    ],
    ai: [
        { name: "LangChain", icon: TerminalSquare, level: "Advanced" },
        { name: "Ollama", icon: Server, level: "Intermediate" },
        { name: "LLM Integration", icon: PlugZap, level: "Advanced" },
    ],
    project_management: [
        { name: "Jira", icon: FileText, level: "Advanced" },
